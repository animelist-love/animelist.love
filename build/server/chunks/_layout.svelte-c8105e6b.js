import { c as create_ssr_component, b as subscribe, o as onDestroy, v as validate_component, f as each, h as add_attribute, e as escape, a as add_styles } from './index2-5765a0e9.js';
import { w as writable } from './index-35f824f0.js';
import { i as isSideNavBar, a as isTopNavbarBgTransparent, b as isBottomTabBar } from './UserSettingStore-30a153bb.js';
...
import { a as getCharacterDetails, b as getStaffDetails } from './index3-f4b10c8e.js';
...
const SideNavbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<aside class="${[
    ...
    return `<a${add_attribute("href", footerLink.route.path, 0)}>${escape(footerLink.name)}</a>`;
      ...
      <div class="flex p-4 text-sm text-neutral-400">© ${escape(( new Date()).getFullYear())} Anilist
      </div></div></div></aside>`;
});
...
//# sourceMappingURL=_layout.svelte-c8105e6b.js.map
