...
{#if isSuccess}
  ...
  >
    <div
      ...
      class="w-full aspect-w-2 aspect-h-3 md:aspect-w-12 md:aspect-h-8 xl:aspect-w-15 xl:aspect-h-6 2xl:aspect-w-14 2xl:aspect-h-[4.8] lg:overflow-hidden mb-12 lg:mb-0 cursor-pointer transition-[border-radius] duration-300"
    >
      <!-- Image -->
      <div
        class="w-full h-full"
...
{:else if isLoading}
  <div class="flex w-full pb-2 transition-[padding,border-radius] duration-300">
    <div
      class="w-full lg:bg-neutral-800 aspect-w-2 aspect-h-3 md:aspect-w-12 md:aspect-h-8 xl:aspect-w-15 xl:aspect-h-6 2xl:aspect-w-14 2xl:aspect-h-[4.8] lg:overflow-hidden mb-12 lg:mb-0 transition-[border-radius] duration-300"
    >
      <div class="w-full h-full">
        <div
          class="lg:hidden w-full h-2/5 -bottom-0.5 absolute bg-gradient-to-t from-background via-background/80 to-transparent"
