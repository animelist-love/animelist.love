import * as universal from '../entries/pages/(app)/manga/details/_url_/_layout.ts.js';

export const index = 4;
export const component = async () => (await import('../entries/pages/(app)/manga/details/_url_/_layout@(app).svelte.js')).default;
export const file = '_app/immutable/entry/(app)-manga-details-_url_-layout@(app).svelte.81d8fd8f.js';
export { universal };
export const universal_id = "src/routes/(app)/manga/details/[url]/+layout.ts";
